...
class ValidationResult {
  static ValidationTypes = {
    ...
    Rule: "Rule",
    Database: "Database",
    // Raised by a service outside the form/rule cycle (e.g. on-device inference) and cleared by
    // that same service. Must not be regenerated by a rule cycle, so — unlike Form — it survives
    // AbstractDataEntryState's per-page validation reset.
    Inference: "Inference"
  }
