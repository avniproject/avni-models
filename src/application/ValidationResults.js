...
class ValidationResults {
    ...
    addOrReplace(validationResult) {
        _.remove(this.validationResults, (result) => result === this.resultFor(validationResult.formIdentifier));
    ...
    clone() {
        const validationResultsClone = _.map(this.validationResults, (result)=> ValidationResult.clone(result));
