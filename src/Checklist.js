...
class Checklist extends BaseEntity {
    ...
    static parentAssociations = () => new Map([[ProgramEnrolment, 'programEnrolmentUUID'], [ChecklistDetail, "checklistDetailUUID"]]);
    ...
    static associateChild(child, childEntityClass, childResource, entityService) {
        let checklist = BaseEntity.getParentEntity(entityService, childEntityClass, childResource, "checklistUUID", Checklist.schema.name);
