...
class SubjectType extends ReferenceEntity {
  static schema = {
    ...
    properties: {
      ...
      validFirstNameFormat: {type: "EmbeddedFormat", optional: true},
      validMiddleNameFormat: {type: "EmbeddedFormat", optional: true},
      validLastNameFormat: {type: "EmbeddedFormat", optional: true},
