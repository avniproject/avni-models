...
class SubjectType extends ReferenceEntity {
  static schema = {
    ...
    properties: {
      ...
      validFirstNameFormat: { type: 'object', objectType: 'EmbeddedFormat', optional: true },
      validMiddleNameFormat: { type: 'object', objectType: 'EmbeddedFormat', optional: true },
      validLastNameFormat: { type: 'object', objectType: 'EmbeddedFormat', optional: true },
