...
class AbstractEncounter extends BaseEntity {
    ...
    static fromResource(resource, entityService) {
        const encounter = new this();
        General.assignFields(resource, encounter, ["uuid", "voided"], ["encounterDateTime"], ["observations", "cancelObservations"], entityService);
        encounter.encounterType = entityService.findByKey("uuid", ResourceUtil.getUUIDFor(resource, "encounterTypeUUID"), EncounterType.schema.name);

        General.assignDateFields(["earliestVisitDateTime", "maxVisitDateTime", "cancelDateTime"], resource, encounter);
